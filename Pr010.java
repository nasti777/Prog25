...
class Pr010 {
	public static void main (String args[]) {
		...
		//Проверка строк на эквивалетность
		...
		System.out.println("Индекст первого вхождения подстроки: " + str1.indexOf("строка"));
		...
		System.out.println("Индекст последнего вхождения подстроки: " + str1.lastIndexOf("строка"));		
	}
}
